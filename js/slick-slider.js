...
$(document).ready(function() {
  ...
  $('.pane-gallery-image-header-nesbitt-gallery-slider .view-content').slick({
    centerMode: true,
    centerPadding: '23%',
    slidesToShow: 1,
    autoplay: true,
  ...
  function set_slide_heights(baseHeight) {
    ...
    $('.view-display-id-nesbitt_gallery_slider .slick-slide').css('max-height', sideSlide);
    $('.view-display-id-nesbitt_gallery_slider .slick-slide').css('margin-top', margin);
    ...
    if (count) {
      $('.view-display-id-nesbitt_gallery_slider .slick-slide.slick-center').next().css('max-height', baseHeight);
      $('.view-display-id-nesbitt_gallery_slider .slick-slide.slick-center').next().css('margin-top', '0');
    }
    else {
      $('.view-display-id-nesbitt_gallery_slider .slick-slide.slick-center').css('max-height', baseHeight);
      $('.view-display-id-nesbitt_gallery_slider .slick-slide.slick-center').css('margin-top', '0');
    }
    count++;
  }
